...
caffe.set_mode_cpu()
net = caffe.Net(caffe_root + 'project/test_examples/mnist/mnist_autoencoder_vis.prototxt',
...
plt.savefig('visualize/viz_results/ae_topology/input.png')
...
vis_square(filters)
plt.savefig('visualize/viz_results/ae_topology/encode1_filters.png')

#encode1 output
feat = net.blobs['encode1'].data[0]
feat = np.reshape(feat, (-1,10,10)) # 1000 = 10x10x10
vis_square(feat,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode1_output.png')
...
vis_square(tst)
plt.savefig('visualize/viz_results/ae_topology/encode2_filters_100.png')
tst = np.reshape(filters,(-1,25,25)) #800x25x25
vis_square(tst)
plt.savefig('visualize/viz_results/ae_topology/encode2_filters_25.png')
...
vis_square(feat,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode2_output.png')

#encode3 filters
filters = net.params['encode3'][0].data #250x500
tst = np.reshape(filters,(-1,10,10)) #1250x10x10
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode3_filters_10.png')
tst = np.reshape(filters,(-1,250,250)) #2x250x250
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode3_filters_250.png')

#encode3 output
feat = net.blobs['encode3'].data[0] #250
tst = np.reshape(feat,(-1,5,5)) #10x5x5
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode3_output.png')

#encode4 filters
filters = net.params['encode4'][0].data #30x250
tst = np.reshape(filters,(-1,50,50))
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode4_filters_50.png')
tst = np.reshape(filters,(-1,10,10))
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/encode4_filters_10.png')
...
tst = np.reshape(filters,(-1,50,50))
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode4_filters_50.png')
tst = np.reshape(filters,(-1,10,10))
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode4_filters_10.png')
...
tst = np.reshape(filters,(-1,10,10)) #1250x10x10
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode3_filters_10.png')
tst = np.reshape(filters,(-1,250,250)) #2x250x250
vis_square(tst,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode3_filters_250.png')

#decode3 output
feat = net.blobs['decode3'].data[0] #500
feat = np.reshape(feat, (-1,10,10)) # 500 = 5x10x10
vis_square(feat,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode3_output.png')

# decode2 filters
filters = net.params['decode2'][0].data #500x1000
tst = np.reshape(filters,(-1,100,100)) #50x100x100
vis_square(tst)
plt.savefig('visualize/viz_results/ae_topology/decode2_filters_100.png')
tst = np.reshape(filters,(-1,25,25)) #800x25x25
vis_square(tst)
plt.savefig('visualize/viz_results/ae_topology/decode2_filters_25.png')
...
feat = np.reshape(feat, (-1,10,10)) # 1000 = 10x10x10
vis_square(feat,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode2_output.png')

# decode1 filters
filters = net.params['decode1'][0].data #1000x784
filters = np.reshape(filters,(-1,28,28)) #1000x28x28
vis_square(filters)
plt.savefig('visualize/viz_results/ae_topology/decode1_filters.png')

#decode1 output
feat = net.blobs['decode1'].data[0]
feat = np.reshape(feat, (-1,28,28)) # 1000 = 1x28x28
vis_square(feat,padval=0.5)
plt.savefig('visualize/viz_results/ae_topology/decode1_output.png')
