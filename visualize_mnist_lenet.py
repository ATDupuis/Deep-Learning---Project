...
plt.savefig('visualize/viz_results/mnist_lenet/input.png')
...
plt.savefig('visualize/viz_results/mnist_lenet/conv1_filters.png')

#output
feat = net.blobs['conv1'].data[0]
feat = np.reshape(feat, (-1, 24,24))  
vis_square(feat, padval=0.5)
plt.savefig('visualize/viz_results/mnist_lenet/conv1_output.png')
...
vis_square(feat, padval=0.5)
plt.savefig('visualize/viz_results/mnist_lenet/pool1_output.png')
...
filters_normal = np.reshape(filters, (-1, 5,5))
vis_square(filters_normal)
plt.savefig('visualize/viz_results/mnist_lenet/conv2_filters.png')

#output
feat = net.blobs['conv2'].data[0]
feat = np.reshape(feat, (-1, 8,8)) 
vis_square(feat, padval=0.5)
plt.savefig('visualize/viz_results/mnist_lenet/conv2_output.png')
...
vis_square(feat, padval=0.5)
plt.savefig('visualize/viz_results/mnist_lenet/pool2_output.png')
...
vis_square(filters_normal)
plt.savefig('visualize/viz_results/mnist_lenet/ip1_filters.png')

filters_transposed = filters.transpose()
filters_transposed = np.reshape(filters, (-1, 20, 25))
vis_square(filters_transposed)
plt.savefig('visualize/viz_results/mnist_lenet/ip1_filters_transposed.png')

# output
feat = net.blobs['ip1'].data[0]
feat = np.reshape(feat, (-1, 20, 25))  # B*1024 = Bx32x32
vis_square(feat, padval=0.5)
plt.savefig('visualize/viz_results/mnist_lenet/ip1_output.png')
...
vis_square(filters_normal)
plt.savefig('visualize/viz_results/mnist_lenet/ip2_filters.png')
...
vis_square(filters_transposed)
plt.savefig('visualize/viz_results/mnist_lenet/ip2_filters_transposed.png')
...
plt.clf()
plt.plot(feat.flat)
plt.savefig('visualize/viz_results/mnist_lenet/ip2_output_graph.png')

feat = np.reshape(feat, (-1, 1, 10))  # B*900 --> Bx10x10
vis_square(feat, padval=0.5)
plt.clf()
plt.savefig('visualize/viz_results/mnist_lenet/ip2_output.png')